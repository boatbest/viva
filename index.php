  ...
  <section id="header-slider" class="section section-slide">
    <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active"> <img  width="100%" src="images/Untitled-5.jpg" alt="Chania">
        </div>
        <div class="item "> <img  width="100%" src="images/banner-5.jpg" alt="Chania">
        </div>
      </div>
      <!-- Controls --> 
      ...
      <div class="row">
          ...
          <div class="services-content">
            ...
            <div class="row"> 
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product">
                  <img src="images/pd1.jpg" class="img-responsive">
                </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product">
                  <img src="images/pd2.jpg" class="img-responsive">
                </div>
                <div class="title-product center-content">
                  <h5>สินค้าชิ้นที่ 1</h5>
                    <label class="price-sale" style="display: block;">1,200 บาท</label>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product">
                  <img src="images/pd3.jpg" class="img-responsive">
                </div>
                <div class="title-product center-content">
                  <h5>สินค้าชิ้นที่ 1</h5>
                    <label class="price-sale" style="display: block;">1,200 บาท</label>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product">
                  <img src="images/pd4.jpg" class="img-responsive">
                </div>
                <div class="title-product center-content">
                  <h5>สินค้าชิ้นที่ 1</h5>
                    <label class="price-sale" style="display: block;">1,200 บาท</label>
        ...
        <div class="col-lg-12 col-sm-12">
          <div class="services-content center-content">
            ...
            <div> 
              <img class="index_line" src="images/line.jpg" alt="line-qr">
            </div>
            <div>
              <img src="images/add-friend-1.png" class="add_line">
            </div>
          </div>
          <div class="center-content">
